...
let bits_to_bars = (array, start_x = 0, start_y = 0) => {
    let scaler = 1;
    push();
    strokeWeight(scaler);
    for (var i = 0; i < array.length-1; i+=1) {
        ...
        if (debug) {
            ...
            // // col = color("green");
            // // fill(0, 255, 0, 5);
            // rect(start_x, start_y + 20, 3 * scaler, start_y+20);
            // // rect(start_x+array.length * scaler, start_y + 20, 3 * scaler, start_y+20);
            // pop();
            // }
        }
        //debug end
